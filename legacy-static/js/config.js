...
window.VDEAR_CONFIG = {
  ...
  timeframes: [
    { id: '5m', label: '5 phút', k: 'tf.5m', binance: '5m', weight: 0.4 },
    { id: '15m', label: '15 phút', k: 'tf.15m', binance: '15m', weight: 0.6 },
    { id: '30m', label: '30 phút', k: 'tf.30m', binance: '30m', weight: 0.75 },
    { id: '1h', label: '1 giờ', k: 'tf.1h', binance: '1h', weight: 1.0 },
    { id: '2h', label: '2 giờ', k: 'tf.2h', binance: '2h', weight: 1.2 },
    { id: '4h', label: '4 giờ', k: 'tf.4h', binance: '4h', weight: 1.5 },
    { id: '10h', label: '10 giờ', k: 'tf.10h', binance: '12h', weight: 1.7, note: 'gần 10h' },
    { id: '12h', label: '12 giờ', k: 'tf.12h', binance: '12h', weight: 1.8 },
    { id: '1d', label: '1 ngày', k: 'tf.1d', binance: '1d', weight: 2.0 },
    { id: '1w', label: '1 tuần', k: 'tf.1w', binance: '1w', weight: 2.4 },
    { id: '1M', label: '1 tháng', k: 'tf.1M', binance: '1M', weight: 2.8 },
  ],
  ...
  sectors: [
    { id: 'all', label: 'Tất cả', k: 'sector.all', icon: '🌐' },
    ...
    { id: 'exchange', label: 'Sàn (CEX)', k: 'sector.exchange', icon: '💠', coins: ['BNB','OKB','CRO','KCS','GT','MX'] },
    { id: 'payments', label: 'Thanh toán', k: 'sector.payments', icon: '💸', coins: ['XRP','LTC','BCH','XLM','TRX','ALGO'] },
