...
(function () {
  ...
  var VI = {
    ...
    /* tầng dữ liệu lệnh khớp: CVD + Volume Profile */
    'cvd.none': 'Chưa có dữ liệu lệnh khớp cho khung này',
    'cvd.approx': '(xấp xỉ)',
    'tape.live': 'Đang nhận lệnh khớp',
    'tape.off': 'Chưa kết nối luồng lệnh khớp',
    'tape.window': 'có {n} phút dữ liệu thật',
    'tape.windowHours': 'có {n} giờ dữ liệu thật',
    'tape.windowDays': 'có {n} ngày dữ liệu thật',
    'tape.gap': 'Mất kết nối lâu hơn {n} phút nên chuỗi bị thiếu một đoạn — không nối liền hai đầu.',
    'vp.toggle': 'Volume Profile',
    'vp.srcTape': 'Profile dựng từ lệnh khớp thật',
    'vp.srcCandle': 'Profile dựng từ nến (xấp xỉ: khối lượng rải đều trên dải mỗi nến)',
    'vp.tier.up': 'Vùng S&R trùng {at} của Volume Profile — giá đã dừng ở đây nhiều lần, mức này đáng tin hơn. Đây là bậc tin cậy riêng, không cộng vào thang hội tụ 5 điều kiện.',
    'vp.tier.down': 'Vùng S&R nằm trong vùng thanh khoản mỏng — giá thường đi xuyên nhanh qua đây, đặt dừng lỗ ở đây dễ bị quét. Đây là bậc tin cậy riêng, không trừ vào thang hội tụ 5 điều kiện.',
    'vp.tier.none': 'Vùng S&R không trùng POC, biên vùng giá trị hay vùng mỏng nào — Volume Profile không nói thêm gì về mức này.',
    'vp.poc': 'POC',
    'vp.vah': 'biên trên vùng giá trị',
    'vp.val': 'biên dưới vùng giá trị',
    /* ngày giờ */
  ...
  var EN = {
    ...
    /* trade-level tape: CVD + Volume Profile */
    'cvd.none': 'No trade data for this timeframe yet',
    'cvd.approx': '(approximate)',
    'tape.live': 'Receiving trades',
    'tape.off': 'Trade stream not connected',
    'tape.window': '{n} minutes of real data',
    'tape.windowHours': '{n} hours of real data',
    'tape.windowDays': '{n} days of real data',
    'tape.gap': 'The connection was lost for more than {n} minutes, so the series is missing a stretch — the two ends are not joined up.',
    'vp.toggle': 'Volume Profile',
    'vp.srcTape': 'Profile built from real trades',
    'vp.srcCandle': 'Profile built from candles (approximate: volume spread evenly across each candle’s range)',
    'vp.tier.up': 'The S&R zone coincides with the profile’s {at} — price has stalled here repeatedly, so the level is more trustworthy. This is a separate confidence tier; it is not added to the 5-condition confluence score.',
    'vp.tier.down': 'The S&R zone sits in a thin-liquidity pocket — price tends to cut straight through, and a stop placed here is easily swept. This is a separate confidence tier; it is not subtracted from the 5-condition confluence score.',
    'vp.tier.none': 'The S&R zone matches no POC, value-area edge or thin pocket — the Volume Profile adds nothing about this level.',
    'vp.poc': 'POC',
