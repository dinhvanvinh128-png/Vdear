...
(function () {
  ...
  var VI = {
    ...
    'oip.title': '🧱 Open Interest toàn thị trường',
    'oip.table.title': '📊 OI theo từng coin',
    'oip.th.chg24': 'Giá 24h',
    'oip.th.oi': 'OI hiện tại',
    'oip.th.oi24': 'ΔOI 24h',
    'oip.th.state': 'Trạng thái',
    'oip.filter.all': 'Tất cả',
    'oip.filter.aria': 'Lọc theo trạng thái',
    'oip.sum.scanned': 'Coin có dữ liệu',
    'oip.sum.oiUp': 'OI tăng',
    'oip.sum.oiDown': 'OI giảm',
    'oip.sum.longsIn': 'Tiền mới vào long',
    'oip.sum.shortsIn': 'Tiền mới vào short',
    'oip.loading': 'Đang tải dữ liệu quét…',
    'oip.loadingSeries': 'Đang tải chuỗi…',
    'oip.empty': 'Không có coin nào khớp bộ lọc đang chọn.',
    'oip.marketFail': 'Lượt quét có dữ liệu nhưng bảng giá thị trường không tải được, nên chưa ghép được coin nào. Đây là lỗi tải giá, không phải thị trường trống.',
    'oip.scanFail': 'Lượt quét không lấy được dữ liệu. Đây là lỗi tải, không phải thị trường trống — thử lại sau ít phút.',
    'oip.noState': 'Thiếu ΔOI hoặc Δgiá nên không gán trạng thái nào. Chỗ trống khác với đi ngang.',
    'oip.noState.head': 'Chưa đủ dữ liệu',
    'oip.age': 'Số liệu quét cách đây {n} phút',
    'oip.coverage': 'Hiện {shown} coin · lượt quét chạm {scanned} coin theo khối lượng',
    'oip.sparkCap': '{n} điểm gần nhất, khung {tf}',
    'oip.sparkAria': 'Đường Open Interest theo thời gian',
    'lsp.title': '⚖️ Tỉ lệ Long / Short',
    'lsp.table.title': '📊 Tỉ lệ tài khoản theo từng coin',
    'lsp.th.bar': 'Long / Short (tài khoản)',
    'lsp.th.long': '% Long',
    'lsp.filter.aria': 'Lọc theo độ nghiêng',
    'lsp.sum.avg': '% Long trung bình',
    'lsp.sum.leanLong': 'Nghiêng long',
    'lsp.sum.balanced': 'Gần cân',
    'lsp.sum.leanShort': 'Nghiêng short',
    'lsp.sum.avgNote': 'Trung bình không trọng số — mỗi coin một phiếu, coin nhỏ cân bằng coin lớn. "Nghiêng" nghĩa là một bên chiếm từ {n}% trở lên.',
    'lsp.detail.globalNote': 'Đếm đầu người: bao nhiêu phần trăm tài khoản đang giữ long.',
    'lsp.detail.topNote': 'Đếm tiền: bao nhiêu phần trăm giá trị vị thế của nhóm tài khoản lớn nhất là long.',
    'lsp.div.crowdLong': 'Đông người đứng bên long ({g} tài khoản) trong khi phần lớn tiền của nhóm lớn nhất đứng bên short ({t}). Đây là mô tả trạng thái hiện tại, không phải dự báo giá.',
    'lsp.div.crowdShort': 'Đông người đứng bên short ({g} tài khoản) trong khi phần lớn tiền của nhóm lớn nhất đứng bên long ({t}). Đây là mô tả trạng thái hiện tại, không phải dự báo giá.',
  ...
  var EN = {
    ...
    /* Open Interest + Long/Short */
    'oip.hint': 'Open Interest is the <b>total value of derivative contracts currently open</b> \u2014 not trading volume. Volume counts how many times something changed hands; OI counts how many positions are still sitting there. Rising OI means new money is entering; falling OI means positions are being closed. Pair OI with price direction and you get the <b>four states</b> in the last column.',
    'oip.note': 'Click a row to see that coin\u2019s OI line over time. Coins outside the scan\u2019s reach show <b>\u2014</b>: that means <i>not scanned yet</i>, not <i>zero</i>.',
    'lsp.hint': 'Binance publishes <b>two</b> long/short ratios, and they <b>do not measure the same thing</b>:',
    'lsp.def.global': '<b>The account ratio</b> counts <b>people</b>: what percentage of accounts is currently long. A $100 account and a $10 million account count the same.',
    'lsp.def.top': '<b>The top-trader position ratio</b> counts <b>money</b>: what percentage of the largest accounts\u2019 position value is long.',
    'lsp.warn': 'So the two <b>must not be mixed</b>, and a gap between them is not a data error \u2014 it is precisely the thing worth looking at: many people on one side while most of the money sits on the other. This <b>describes the state of the crowd</b>; it is not a forecast and not a recommendation.',
    'lsp.note': 'Click a row to load the <b>top-trader position ratio</b> for that coin and place it beside the account ratio. Coins outside the scan\u2019s reach show <b>\u2014</b>: that means <i>not scanned yet</i>, not <i>zero</i>.',
    'oip.title': '🧱 Market-wide Open Interest',
    'oip.table.title': '📊 OI by coin',
    'oip.th.chg24': 'Price 24h',
    'oip.th.oi': 'Current OI',
    'oip.th.oi24': 'ΔOI 24h',
    'oip.th.state': 'State',
    'oip.filter.all': 'All',
    'oip.filter.aria': 'Filter by state',
    'oip.sum.scanned': 'Coins with data',
    'oip.sum.oiUp': 'OI rising',
    'oip.sum.oiDown': 'OI falling',
    'oip.sum.longsIn': 'New longs entering',
    'oip.sum.shortsIn': 'New shorts entering',
    'oip.loading': 'Loading scan data…',
    'oip.loadingSeries': 'Loading series…',
    'oip.empty': 'No coin matches the selected filter.',
    'oip.marketFail': 'The scan has data but the market price table failed to load, so no coin could be paired up. This is a price-loading failure, not an empty market.',
    'oip.scanFail': 'The scan could not fetch data. This is a loading failure, not an empty market — try again in a few minutes.',
    'oip.noState': 'ΔOI or Δprice is missing, so no state is assigned. Missing is not the same as flat.',
    'oip.noState.head': 'Not enough data',
    'oip.age': 'Scan data is {n} minutes old',
    'oip.coverage': 'Showing {shown} coins · the scan reaches {scanned} coins by volume',
    'oip.sparkCap': 'Last {n} points, {tf} timeframe',
    'oip.sparkAria': 'Open Interest over time',
    'lsp.title': '⚖️ Long / Short ratio',
    'lsp.table.title': '📊 Account ratio by coin',
    'lsp.th.bar': 'Long / Short (accounts)',
    'lsp.th.long': '% Long',
    'lsp.filter.aria': 'Filter by skew',
    'lsp.sum.avg': 'Average % long',
    'lsp.sum.leanLong': 'Leaning long',
    'lsp.sum.balanced': 'Near balanced',
    'lsp.sum.leanShort': 'Leaning short',
    'lsp.sum.avgNote': 'Unweighted average — one vote per coin, so a small coin counts the same as a large one. "Leaning" means one side holds {n}% or more.',
    'lsp.detail.globalNote': 'Counts people: what share of accounts is currently long.',
    'lsp.detail.topNote': 'Counts money: what share of the largest accounts\u2019 position value is long.',
    'lsp.div.crowdLong': 'More accounts sit on the long side ({g} of accounts) while most of the largest accounts\u2019 money sits short ({t}). This describes the current state; it is not a price forecast.',
    'lsp.div.crowdShort': 'More accounts sit on the short side ({g} of accounts) while most of the largest accounts\u2019 money sits long ({t}). This describes the current state; it is not a price forecast.',
    'oi.label': 'Open Interest',
    'oi.short': 'OI',
